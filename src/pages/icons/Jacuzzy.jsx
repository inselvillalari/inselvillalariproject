      ...
      >
        <g id="Jacuzzi">
          ...
          <path
            ...
            fill="#f4a261"
          ></path>
          <path d="m14.21 60.24h15.75v5.58h-15.75z" fill="#f47a61"></path>
          ...
          <path
            ...
            fill="#302d3d"
          ></path>
          <path d="m7.47 65.83h81.06v9.72h-81.06z" fill="#f47a61"></path>
          <path
            d="m77.72 75.55h-59.44a4.86 4.86 0 0 1 0-9.72h59.44a4.86 4.86 0 0 1 0 9.72z"
            fill="#f4a261"
          ></path>
          <path d="m7.47 65.83h81.06v4.34h-81.06z" fill="#db6b61"></path>
          <rect
            fill="#ffd489"
            height="2.71"
            rx="1.35"
            ...
            y="68.81"
          ></rect>
          <path d="m7.47 75.55h81.06v9.72h-81.06z" fill="#f47a61"></path>
          <path d="m7.47 85.28h81.06v9.72h-81.06z" fill="#f47a61"></path>
          <path
          ...
          <path
            ...
            fill="#f4a261"
          ></path>
          <path d="m7.47 92.25h81.06v2.75h-81.06z" fill="#db6b61"></path>
          <path d="m7.47 82.53h81.06v2.75h-81.06z" fill="#db6b61"></path>
          <path
          ...
          <path
            ...
            fill="#302d3d"
          ></path>
          <circle cx="31.31" cy="41.56" fill="#cbf4ff" r="1.92"></circle>
          <path
          ...
          <path
            ...
            fill="#302d3d"
          ></path>
          <path d="m51.1 36.75a4.65 4.65 0 0 1 -6.1 0" fill="#fff"></path>
          <path
