        ...
        >
          ...
          <div style={{ maxWidth: "800px", margin: "0 auto", padding: "2rem" }}>
            ...
            <p>
              ...
              <strong> www.inselvillalari.com </strong> adresli internet
              sitesini kullanan ziyaretçilerin bilgilerinin gizliliğini korumak
              amacıyla hazırlanmıştır. Bu politika, 6698 sayılı Kişisel
              Verilerin Korunması Kanunu (“KVKK”) hükümleri uyarınca kişisel
              verilerin işlenmesine ilişkindir.
            </p>
            ...
            <p>
              ...
              sağlayıcılarımız (örneğin; ödeme altyapısı, e-posta servisleri)
              ile paylaşılabilir. Verileriniz hiçbir şekilde üçüncü kişilere
              pazarlama amacıyla satılmaz veya devredilmez.
            </p>
            ...
            <p>
              ...
              <strong>info@inselvillalari.com</strong> adresinden
              ulaşabilirsiniz.
            </p>
          </div>
        </div>
