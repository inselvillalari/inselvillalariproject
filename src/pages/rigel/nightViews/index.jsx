...
import ProjectIntro from "../../../components/rigel/nightViews/ProjectIntro";
      ...
      <section className="projdtal">
        <div className="justified-gallery">
          <div className="row">
            ...
            >
              <img alt="" src="/assets/img/slid/rigel/nightViews/1.jpeg" />
            </a>
            <a
              style={{ cursor: "none" }}
...
export default withLoading(RigelNightViews);
